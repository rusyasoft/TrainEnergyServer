...
from werkzeug import secure_filename, safe_join
...
#rustamchange#root = os.path.expanduser('~')
root = os.path.expanduser('/home/rustam/python_poligon/webservers/download')
...
app.add_url_rule('/download', view_func=path_view)
app.add_url_rule('/download/<path:p>', view_func=path_view)
